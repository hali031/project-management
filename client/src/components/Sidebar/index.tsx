...
const Sidebar = () => {
    ...
    const sidebarClassNames = `fixed flex flex-col h-[100px] justify-between shadow-xl 
        transiton-all duration-300 h-full z-40 dark:bg-black overflow-y-auto bg-white 
    ...
    return(
        <Link href={href} className='w-full'>
            <div className={`relative flex cursor-pointer items-center gap-3 transition-colors 
                hover:bg-gray-200 dark:bg-black dark:hover:bg-gray-700 ${
